# MS_Fabric_MDD
A Metadata Driven ETL Framework (MDD) built on top of Pyspark and Lakehouse, which could drive the data from end to end with configurations in YAML files.
